package com.example.animationstudio.ui.tvseries
...
import com.example.animationstudio.databinding.FragmentTvseriesBinding
...
class TvseriesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = AnimationAdapter(requireContext(), animeList) {
            val intent = Intent(requireContext(), DetailAnimation::class.java)
