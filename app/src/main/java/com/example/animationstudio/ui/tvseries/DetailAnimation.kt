...
class DetailAnimation : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.detail_animation)

        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        val animation = intent.getParcelableExtra<AnimationClass>(TvseriesFragment.INTENT_PARCELABLE)
